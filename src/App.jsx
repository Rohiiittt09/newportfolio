...
const onsubmit = async (data) => {
  ...
  return (
     ...
     <div className='fixed flex gap-4 right-10 bottom-10 z-40 '>
      <a href="https://www.linkedin.com/in/rohit-singh-9a994a317/"><svg
...
<a href="https://github.com/Rohiiittt09/"><svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
  fill="currentColor"
  ...
  <div
    ...
    <div className=' animate-left'>
      ...
      <p
        ...
        Express, MongoDB and WebSockets.
    ...
    <div
      ...
      <div
        className="relative
        overflow-hidden border-b-4  border-zinc-400
        rounded-[35px]
...
<section id='' className=' relative min-h-screen overflow-hidden bg-[#050505] text-white flex flex-col '>
  ...
  <h1 className="uppercase text-center w-full md:text-4xl text-2xl md:tracking-[10px]
        text-zinc-500
        mb-6
        ">ABOUT ME</h1>
  </div>
  <div className=' w-full p-5 md:p-0 md:w-4/6  md:mt-10 mx-auto   '>
  <p className="uppercase text-center w-full text-[12px] md:text-[18px] 
        text-red-500
        mb-6
  ...
  <div id='skills' className=' md:mt-20 w-screen flex flex-col items-center gap-5 '>
...
<h1 className='uppercase text-center w-full text-[12px] lg:text-2xl lg:tracking-[6px]
        text-zinc-500
        mb-6'>html</h1>
  </div>
  <div className=' flex flex-col items-center w-fit justify-center'>
...
<h1 className='uppercase text-center w-full text-[12px] lg:text-2xl lg:tracking-[6px]
  ...
  <path
    fill="#b91c1c"
    d="M77.5 73.5 94 92h-9.5L72.8 79.2z"/>
</svg>
<h1 className='uppercase text-center w-full text-[12px] lg:text-2xl lg:tracking-[6px]
        text-zinc-500
        mb-6'>next.js</h1>
...
<section id='projects' className='relative  min-h-screen overflow-hidden bg-[#050505] text-white flex flex-col'>
  <div className="absolute inset-0 opacity-15">
    <div
      className="h-full w-full 
      bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)]
  ...
  <div className='lg:w-4/5 flex flex-col gap-3 w-full lg:mt-0 mt-20 h-full  p-5'>
    <h1 className='uppercase  text-center w-full md:text-4xl text-2xl 
        text-zinc-500
        mb-6'>Velix chat-app</h1>
        <p className='  text-[10px] sm:text-[16px] w-full    text-red-500 text-center'>Built a modern full-stack real-time chat application using React, Express.js, MongoDB, and Socket.IO. Implemented JWT-based authentication, secure login/signup, username-based conversations, and instant messaging with a responsive user interface.</p>
         <a
 ...
 <div className='w-4/5   mx-auto lg:h-95 lg:mt-10 mt-20  '>
  ...
  <div className='lg:w-4/5 w-full flex flex-col lg:mt-0 gap-3 mt-20 h-full  p-5'>
    <h1 className='uppercase  text-center w-full md:text-4xl text-2xl 
        text-zinc-500
        mb-6'>Universal Cafe </h1>
        <p className='  text-[10px] sm:text-[16px] w-full    text-red-500 text-center'>Developed a full-stack café web application using Next.js and MongoDB, featuring NextAuth authentication, admin dashboard, dynamic menu management, shopping cart, order history, and Razorpay payment integration. Designed a responsive and user-friendly interface with secure authentication and seamless online ordering.</p>
         <a
 ...
 <div className='w-4/5   mx-auto lg:h-95 mt-20 lg:mt-10  '>
  ...
  <div className='lg:w-4/5 flex flex-col gap-3 w-full lg:mt-0 mt-20 h-full  p-5'>
    <h1 className='uppercase  text-center w-full md:text-4xl text-2xl 
        text-zinc-500
        mb-6'>Elevate Studio</h1>
        <p className='  text-[10px] sm:text-[16px] w-full    text-red-500 text-center'>Designed and developed a modern, responsive photography studio website using React and Tailwind CSS. Showcased services, portfolio, contact information, and session booking with WhatsApp integration, delivering a smooth and user-friendly experience across all devices.</p>
         <a
...
<section className='relative min-h-screen overflow-hidden bg-[#050505] text-white flex flex-col'>
 ...
 <div className='w-4/5   mx-auto lg:h-95 mt-10  '>
  ...
  <div className='lg:w-4/5 flex flex-col gap-3 lg:mt-0 w-full mt-20 h-full  p-5'>
    <h1 className='uppercase  text-center w-full md:text-4xl text-2xl 
        text-zinc-500
        mb-6'>Editor Portfolio Website 1</h1>
        <p className='  text-[10px] sm:text-[16px] w-full    text-red-500 text-center'>Built a custom pink-themed portfolio website tailored to the client's requirements using React and Tailwind CSS. Created a responsive, visually engaging interface with service highlights, portfolio showcase, and WhatsApp integration for direct inquiries.</p>
         <a
 ...
 <div className='w-4/5   mx-auto lg:h-95 lg:mt-10 mt-20  '>
  ...
  <div className='lg:w-4/5 w-full flex flex-col lg:gap-0 lg:mt-0 gap-3 mt-20 h-full  p-5'>
    <h1 className='uppercase  text-center w-full md:text-4xl text-2xl 
        text-zinc-500
        mb-6'>Editor Portfolio Website 2</h1>
        <p className='  text-[10px] sm:text-[16px] w-full    text-red-500 text-center'>Designed and developed a modern dark-themed portfolio website for a video editor using React and Tailwind CSS. Implemented a fully responsive layout, project showcase, and WhatsApp integration for seamless client communication.</p>
         <a
...
<section id='contact' className='relative min-h-screen overflow-hidden bg-[#050505] text-white flex flex-col'>
  <div className="absolute inset-0 opacity-15">
    <div
      className="h-full w-full 
      bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)]
